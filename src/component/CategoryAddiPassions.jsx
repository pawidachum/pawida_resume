...
function CategoryAddiPassion(){
    return(
        ...
        {additionalPassion.map((data, index)=>{
            ...
            return(
                <>
                <div className="flex flex-col w-[347px] h-[280px] rounded-xl bg-white shadow-[0px_5px_26px_5px_rgba(0,0,0,0.17)] items-center tracking-wider gap-1">
                    <img key={index} src={data.image} alt={data.alt} className='w-[347px] h-[140px] rounded-t-xl mb-10'/>
