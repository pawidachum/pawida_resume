...
function CategoryAddiPassion(){
    return(
        ...
        {additionalPassion.map((data, index)=>{
            ...
            return(
                <>
                <div key={index}className="flex flex-col w-[447px] h-[380px] rounded-xl bg-white shadow-[0px_5px_26px_5px_rgba(0,0,0,0.17)] items-center tracking-wider gap-1">
                    <img  src={data.image} alt={data.alt} className='w-[447px] h-[240px] rounded-t-xl mb-10'/>
